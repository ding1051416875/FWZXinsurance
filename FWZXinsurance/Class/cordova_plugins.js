...
module.exports = [
 {
        "file": "plugins/cordova-plugin-jstoast/jstoast.js",//js文件路径
        "id": "cordova-plugin-jstoast.JSToast",//js cordova.define的id
        "clobbers": [
            "alertDialog"//js 调用时的方法名
        ]
    },
    {
            "file": "plugins/cordova-plugin-toast/showtoast.js",//js文件路径
            "id": "cordova-plugin-toast.ShowToast",//js cordova.define的id
            "clobbers": [
                "showToast"//js 调用时的方法名
            ]
        },
        {
